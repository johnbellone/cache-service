...
go_repository(
    name = "com_github_pomerium_autocache",
    importpath = "github.com/pomerium/autocache",
    sum = "h1:y73x4eEnZkCHdC46HG2h+ZAuNQUW1tu7hgvC7v+jI2o=",
    version = "v0.0.0-20200505053831-8c1cd659f055",
)
...
go_repository(
    ...
    sum = "h1:euYVGiPX8rewJLthz0QcjYLZDxM5qw5K7RWB5FYAOcM=",
    version = "v3.3.21+incompatible",
)
